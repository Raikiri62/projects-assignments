...
public static class ConsoleInput
{
    ...
    private static ConsoleKeyInfo ReadKeyWithoutMovingTheCursor()
    {
    ...
    private static bool s_FirstReadKey = true;
    ...
    public static ConsoleKeyInfo ReadKey()
    {
        ...
        if (s_FirstReadKey)
        {
            s_FirstReadKey = false;
            consoleKeyInfo = Console.ReadKey(not(v_intercept));
        }
        else
        {
            Console.Write("\b \b");
    ...
    public static void ResetFirstReadKeyToTrue()
    {
        s_FirstReadKey = true;
    }
}