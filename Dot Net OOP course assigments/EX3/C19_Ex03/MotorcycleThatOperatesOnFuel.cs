namespace C19_Ex03_GarageLogic
{
    ...
    public class MotorcycleThatOperatesOnFuel : VehicleThatOperatesOnFuel
    {
        internal const eTypeOfFuel k_TypeOfFuel = eTypeOfFuel.Octan95;
        internal const float k_CapacityOfTank = 5.5f;
        ...
        public MotorcycleThatOperatesOnFuel(TextReader i_TextReader)
        ...
        public MotorcycleThatOperatesOnFuel(TextReader i_TextReader, byte i_NumberOfWheels)
            : base(i_TextReader, i_NumberOfWheels, k_MaximumWheelAirPressure, k_TypeOfFuel, k_CapacityOfTank)
        {
            m_motorcycle = new Motorcycle(i_TextReader);
        }

        public MotorcycleThatOperatesOnFuel(TextReader i_TextReader, float i_MaximumWheelAirPressure)
            : base(i_TextReader, k_NumberOfWheels, i_MaximumWheelAirPressure, k_TypeOfFuel, k_CapacityOfTank)
        {
            m_motorcycle = new Motorcycle(i_TextReader);
        }

        public MotorcycleThatOperatesOnFuel(TextReader i_TextReader, byte i_NumberOfWheels, float i_MaximumWheelAirPressure)
        ...
        {
            return "Fuel Motorcycle" + Environment.NewLine + this.ToStringWriter().ToString();
        }
    }
}
